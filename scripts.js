function dataLoaded(BIRDSTRIKES) {
	...
	var myBirdstrikesChart = new google.visualization.LineChart(document.getElementById('myBirdstrikesChartDiv'));
...
function googleLoaded() {
	...
	$.get("merge_strikes_freq.json", dataLoaded, "json");
...
function googleLoaded2() {
	...
	//Time to load data with get function. This will tell my page to go and get this data set and use the function
	//dataLoaded to render it.
	$.get("birdstrikes_flights_PA.json", dataLoaded2, "json");
